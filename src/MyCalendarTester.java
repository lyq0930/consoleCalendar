...
//
//        //create an temperate object for the current monthVIEW to get the first day_of_week
...
//            count ++;
//        }
//        for(int dayVIEW = 1; dayVIEW <= c.getActualMaximum(Calendar.DAY_OF_MONTH); dayVIEW++){
//            if(dayVIEW == c.get(Calendar.DAY_OF_MONTH))
//                System.out.printf("[%d] ", dayVIEW);
//            else
//                System.out.printf("%2d ", dayVIEW);
//            count++;
//            if(count == 7) {
//                System.out.println();
//                count = 0;
